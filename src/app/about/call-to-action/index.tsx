...
import img from "../../../../public/images/Refugee-story.jpg";
  ...
  return (
    <div className="flex flex-col justify-center items-center space-y-10 md:m-20 p-10 md:p-auto md:bg-inherit bg-gray-50">
      <div className="w-full flex flex-col justify-center items-center">
        <Image className="md:w-52" src={img} alt="Call to action img" />
      </div>
      ...
      <div className="flex flex-col justify-center items-center text-left md:w-1/2 text-sm text-gray-400">
        <p>
          ...
          reached a refugee camp in Lebanon. Life in the camp was difficult with
          limited resources and little hope for the future. But Ahmad never gave
          up hope. He knew that he needed to keep moving forward, to find a safe
          place to rebuild his life. He spent his days in the camp helping his
          family and learning new skills, such as learning English and fixing
          bikes. And, after years of waiting, Ahmad and his family were finally
          granted asylum in the United States. Upon arrival, Ahmad faced new
          challenges, such as learning a new language and navigating a new
